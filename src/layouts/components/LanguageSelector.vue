...
<template>
  <div class="d-flex cursor-pointer">
      <VImg :src="langOptions[langSelectedIdx].img" :width="20" class="mr-2"/>
      ...
      >
        <VList>
          <VListItem link @click="changeLang(idx)" v-for="lang, idx in langOptions">
            <template #prepend>
              <VImg :src="lang.img" :width="20" class="mr-2" />
            </template>
